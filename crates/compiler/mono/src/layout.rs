...
use roc_types::subs::{
    ...
    UnsortedUnionLabels, Variable, VariableSubsSlice, TupleElems,
};
use roc_types::types::{gather_fields_unsorted_iter, RecordField, RecordFieldsError, gather_tuple_elems_unsorted_iter, TupleElemsError};
...
fn sort_tuple_elems_help<'a>(
    ...
    sorted_elems.sort_by(
        |(index1, _, res_layout1), (index2, _, res_layout2)| {
            cmp_fields(
                &env.cache.interner,
                index1,
                *res_layout1,
